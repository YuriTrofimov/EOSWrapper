...
#include "EOSWrapperSettings.generated.h"
...
struct FEOSWrapperArtifactSettings
{
	GENERATED_BODY()
...
class EOSWRAPPER_API UEOSWrapperSettings : public URuntimeOptionsBase
{
	GENERATED_BODY()
public:
	/**
	...
	static FEOSWrapperSettings GetSettings();
	FEOSWrapperSettings ToNative() const;
...
private:
	...
	static FEOSWrapperSettings AutoGetSettings();
	static const FEOSWrapperSettings& ManualGetSettings();
};
