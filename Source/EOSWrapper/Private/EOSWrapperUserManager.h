...
public:
	...
	FEOSWrapperUserManager(FEOSWrapperSubsystem* WrapperSubsystem);
...
typedef TSharedPtr<FEOSWrapperUserManager, ESPMode::ThreadSafe> FEOSWrapperUserManagerPtr;
typedef TWeakPtr<FEOSWrapperUserManager, ESPMode::ThreadSafe> FEOSWrapperUserManagerWeakPtr;
typedef TWeakPtr<const FEOSWrapperUserManager, ESPMode::ThreadSafe> FEOSWrapperUserManagerConstWeakPtr;
